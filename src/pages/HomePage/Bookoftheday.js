...
function Bookoftheday() {
  const data = {
    ...
    "cover": "http://books.google.com/books/content?id=HkBlDwAAQBAJ&printsec=frontcover&img=1&zoom=1&edge=curl&source=gbs_api",
    "penulis": [
        "Abdul Kadir"
    ],
    "date": "2017-12-27",
    "penerbit": "Elex Media Komputindo",
    "sinopsis": "Buku yang sangat cocok untuk Anda yang sedang mempelajari dasar pemrograman komputer. Buku ini mengajarkan logika untuk menyelesaikan berbagai masalah yang ditangani oleh komputer dengan menggunakan Flowgorithm. Dengan menggunakan perangkat lunak ini, berbagai permasalahan komputasi dapat diselesaikan dengan menyusun diagram alir. Kemudian, Anda bisa mengujinya untuk memastikan bahwa solusi yang Anda buat memang sudah sesuai atau tidak, tanpa perlu melibatkan orang lain.",
    "readlink": "http://books.google.co.id/books?id=HkBlDwAAQBAJ&printsec=frontcover&dq=intitle:pemrograman&hl=&cd=1&source=gbs_api"
}
        ...
        <div className="container">
          ...
          <div className="row">
            ...
            <div className="col-xl-7 offset-xl-0 col-lg-7 offset-lg-0 col-md-7 offset-md-0 col-sm-12 offset-sm-0 mt-sm-3">
              ...
              <button type="button" class="btn btn-dark" onClick={()=>dispatch(addBookToMyLibrary(data))}>Simpan Baca Nanti</button>
              <a href={`/book/${url}`}>
                <Button className="ms-2" variant="success">Read Now</Button>
              </a>
            </div>
          </div>
        </div>
